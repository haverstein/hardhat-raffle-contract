...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle unit Tests", function () {
          ...
          describe("enterRaffle", function () {
              it("reverts if under-paid", async function () {
                  await expect(raffle.enterRaffle()).to.be.revertedWith(
                      "Raffle__NotEnoughETHEntered"
                  )
              })
              it("records participants", async function () {
              ...
              it("does not allow to enter when calculating", async function () {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
          ...
          describe("performUpkeep", function () {
              ...
              it("revert when upkeep is false", async function () {
          ...
          describe("fulfillRandomWords", function () {
              ...
              it("picks a winner, resets the lottery, and sends money", async function () {
                  ...
                  for (
                      ...
                      //console.log(accounts[i].address) 1 is the winner
                  }
